...
• معدن آهن - $8,000 (1000 واحد/6ساعت)
• معدن مس - $10,000 (800 واحد/6ساعت)
• معدن نفت - $12,000 (600 واحد/6ساعت)
• معدن گاز - $11,000 (700 واحد/6ساعت)
• معدن آلومینیوم - $9,000 (500 واحد/6ساعت)
• معدن طلا - $15,000 (200 واحد/6ساعت)
• معدن اورانیوم - $20,000 (100 واحد/6ساعت)
• معدن لیتیوم - $18,000 (300 واحد/6ساعت)
• معدن زغال‌سنگ - $8,500 (1200 واحد/6ساعت)
• معدن نقره - $14,000 (400 واحد/6ساعت)
...
🏪 آگهی شما در بازار قرار گرفت."""
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Check if user is awaiting official statement
            ...
            player = self.db.get_player(user_id)
            await self.news.send_official_statement(player['country_name'], message, with_penalty_button=True)
