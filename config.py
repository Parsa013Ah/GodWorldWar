...
class Config:
    ...
    BUILDINGS = {
        ...
        'nitro_mine': {'name': 'معدن نیتر', 'cost': 95000, 'production': {'nitro': 100}},
        'sulfur_mine': {'name': 'معدن گوگرد', 'cost': 75000, 'production': {'sulfur': 150}},
        'titanium_mine': {'name': 'معدن تیتانیوم', 'cost': 250000, 'production': {'titanium': 3}},
